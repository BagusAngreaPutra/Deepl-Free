...
AM_TO_BR: dict[str, str] = {
    ...
    # Additional -ise forms and related nouns
    r'\bapologize\b': 'apologise',       r'\bapologized\b': 'apologised',
    r'\bapologizing\b': 'apologising',   r'\bapologizes\b': 'apologises',
    r'\bapologization\b': 'apologisation',
    r'\bcentralize\b': 'centralise',     r'\bcentralized\b': 'centralised',
    r'\bcomputerize\b': 'computerise',   r'\bcomputerized\b': 'computerised',
    r'\bconceptualize\b': 'conceptualise', r'\bconceptualized\b': 'conceptualised',
    r'\bdecentralize\b': 'decentralise', r'\bdecentralized\b': 'decentralised',
    r'\bdehumanize\b': 'dehumanise',     r'\bdehumanized\b': 'dehumanised',
    r'\bdeodorize\b': 'deodorise',       r'\bdeodorized\b': 'deodorised',
    r'\bdecriminalize\b': 'decriminalise', r'\bdecriminalized\b': 'decriminalised',
    r'\bdevalue\b': 'devalue',
    r'\bexternalize\b': 'externalise',   r'\bexternalized\b': 'externalised',
    r'\bgeneralize\b': 'generalise',     r'\bgeneralized\b': 'generalised',
    r'\bgeneralization\b': 'generalisation',
    r'\bidealize\b': 'idealise',         r'\bidealized\b': 'idealised',
    r'\binternalize\b': 'internalise',   r'\binternalized\b': 'internalised',
    r'\bitemize\b': 'itemise',           r'\bitemized\b': 'itemised',
    r'\bmaterialize\b': 'materialise',   r'\bmaterialized\b': 'materialised',
    r'\bmechanize\b': 'mechanise',       r'\bmechanized\b': 'mechanised',
    r'\bmobilize\b': 'mobilise',         r'\bmobilized\b': 'mobilised',
    r'\boperationalize\b': 'operationalise', r'\boperationalized\b': 'operationalised',
    r'\bpublicize\b': 'publicise',       r'\bpublicized\b': 'publicised',
    r'\brealizable\b': 'realisable',     r'\brecognizable\b': 'recognisable',
    r'\bstandardizable\b': 'standardisable', r'\bsynthesizable\b': 'synthesisable',
    r'\bunionize\b': 'unionise',         r'\bunionized\b': 'unionised',

    # Additional -our spellings and derivatives
    r'\bcoloration\b': 'colouration',     r'\bcolorless\b': 'colourless',
    r'\bcoloring\b': 'colouring',         r'\bdiscolor\b': 'discolour',
    r'\bdiscolored\b': 'discoloured',     r'\bmulticolor\b': 'multicolour',
    r'\bfavored\b': 'favoured',           r'\bfavoring\b': 'favouring',
    r'\bflavored\b': 'flavoured',         r'\bflavoring\b': 'flavouring',
    r'\bhonored\b': 'honoured',           r'\bhonoring\b': 'honouring',
    r'\blabored\b': 'laboured',           r'\blaboring\b': 'labouring',
    r'\bneighboring\b': 'neighbouring',   r'\bneighborly\b': 'neighbourly',
    r'\bsavored\b': 'savoured',           r'\bsavory\b': 'savoury',

    # Additional -re, ae/oe and classical spellings
    r'\bcaliber\b': 'calibre',            r'\bcalibers\b': 'calibres',
    r'\bluster\b': 'lustre',              r'\bmillimeter\b': 'millimetre',
    r'\bmillimeters\b': 'millimetres',    r'\bcentimeter\b': 'centimetre',
    r'\bcentimeters\b': 'centimetres',    r'\bkilometer\b': 'kilometre',
    r'\bkilometers\b': 'kilometres',      r'\bamphitheater\b': 'amphitheatre',
    r'\bepicenter\b': 'epicentre',        r'\bhypocenter\b': 'hypocentre',
    r'\baesthetic\b': 'aesthetic',        r'\bestrogen\b': 'oestrogen',
    r'\bfetus\b': 'foetus',               r'\bfetuses\b': 'foetuses',
    r'\bgynecology\b': 'gynaecology',     r'\bgynecologist\b': 'gynaecologist',
    r'\bhematology\b': 'haematology',     r'\bhemoglobin\b': 'haemoglobin',
    r'\bhemorrhage\b': 'haemorrhage',     r'\bhemorrhaging\b': 'haemorrhaging',
    r'\bleukemia\b': 'leukaemia',         r'\borthopedic\b': 'orthopaedic',
    r'\borthopedics\b': 'orthopaedics',   r'\bdiarrhea\b': 'diarrhoea',

    # Additional doubled consonants and inflections
    r'\bcancelation\b': 'cancellation',   r'\bchiseled\b': 'chiselled',
    r'\bchiseling\b': 'chiselling',       r'\bdialed\b': 'dialled',
    r'\bdialing\b': 'dialling',           r'\bdueling\b': 'duelling',
    r'\bexcelled\b': 'excelled',          r'\bgruelling\b': 'gruelling',
    r'\bkidnaped\b': 'kidnapped',         r'\bleveled\b': 'levelled',
    r'\bleveling\b': 'levelling',         r'\bmarveled\b': 'marvelled',
    r'\bmarveling\b': 'marvelling',       r'\bpaneled\b': 'panelled',
    r'\bpaneling\b': 'panelling',         r'\bquarreled\b': 'quarrelled',
    r'\bquarreling\b': 'quarrelling',     r'\brivaled\b': 'rivalled',
    r'\brivaling\b': 'rivalling',         r'\bshoveled\b': 'shovelled',
    r'\bshoveling\b': 'shovelling',       r'\bsignaler\b': 'signaller',

    # Common vocabulary differences
    r'\bairplane\b': 'aeroplane',         r'\bairplanes\b': 'aeroplanes',
    r'\baluminum\b': 'aluminium',         r'\bapartment\b': 'flat',
    r'\bapartments\b': 'flats',           r'\bzip code\b': 'postcode',
    r'\bzip codes\b': 'postcodes',        r'\bcell phone\b': 'mobile phone',
    r'\bcell phones\b': 'mobile phones',  r'\bcheck mark\b': 'tick',
    r'\bcheck marks\b': 'ticks',          r'\bdrugstore\b': 'chemist',
    r'\bdrugstores\b': 'chemists',        r'\belevator\b': 'lift',
    r'\belevators\b': 'lifts',            r'\bflashlight\b': 'torch',
    r'\bflashlights\b': 'torches',        r'\bgarbage can\b': 'rubbish bin',
    r'\bgarbage cans\b': 'rubbish bins',  r'\bline up\b': 'queue',
    r'\bmailbox\b': 'postbox',            r'\bmailboxes\b': 'postboxes',
    r'\bparking lot\b': 'car park',       r'\bparking lots\b': 'car parks',
    r'\bperiod at the end\b': 'full stop at the end',
    r'\bsidewalk\b': 'pavement',          r'\bsidewalks\b': 'pavements',
    r'\bsoccer\b': 'football',            r'\btrash can\b': 'rubbish bin',
    r'\btrash cans\b': 'rubbish bins',    r'\bvacation\b': 'holiday',
    r'\bvacations\b': 'holidays',         r'\bwrench\b': 'spanner',
    r'\bwrenches\b': 'spanners',          r'\byard sale\b': 'jumble sale',

    # Education, office and document terminology
    r'\bdriver license\b': 'driving licence',
    r"\bdriver's license\b": 'driving licence',
    r'\bregistration form\b': 'enrolment form',
    r'\bschool counselor\b': 'school counsellor',
    r'\bstudent counselor\b': 'student counsellor',
    r'\bstandardized test\b': 'standardised test',
    r'\bstandardized tests\b': 'standardised tests',
    r'\btraining center\b': 'training centre',
    r'\bresearch center\b': 'research centre',
    r'\bwriting center\b': 'writing centre',
    r'\bcomputer lab\b': 'computer laboratory',
    r'\bscience lab\b': 'science laboratory',
    r'\bmakeup exam\b': 'resit examination',
    r'\bmakeup exams\b': 'resit examinations',
}
